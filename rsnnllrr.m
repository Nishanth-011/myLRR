...
data_num = 7;
if data_num == 1
load sORL_32x32nnllrr
elseif data_num == 2
load sUmistnnllrr
elseif data_num == 3
load sYaleB_3232nnllrr
elseif data_num == 4
load sCOIL20nnllrr
elseif data_num == 5
    load smnist_allnnllrr
elseif data_num == 6
    load sCCC40nnllrr
elseif data_num == 7
    load sYale_64x64nnllrr
elseif data_num == 8
    load sPD100nnllrr
end
folder_now = pwd;
...
save(strcat('Results/newrevise/',strcat('ss',dataset_name{data_num},'nnllrr')))
%---------------------------------------------------------------